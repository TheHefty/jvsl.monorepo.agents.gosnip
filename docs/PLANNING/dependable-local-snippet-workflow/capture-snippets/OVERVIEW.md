...
No tasks have been defined. Task grilling begins only after this story is merged, and the ordered
index will be added here with the first accepted task design.
